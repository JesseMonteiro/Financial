...
- `purchaseDate` em UTC cortado em `YYYY-MM-DD` separa o PENDING antigo do POSTED da mesma compra (21h BRT vira o dia seguinte: `2025-11-27T03:21Z` vs `2025-11-28T00:57Z`). A série partida desliza a parcela velha para a aberta **e** projeta a parcela certa. `installmentPurchaseDate` usa o dia em `America/Sao_Paulo`. Caso validado (Lucas Amazon, venc. out/2026): PDF **R$ 3.119,34** vs **R$ 3.267,32** — fantasmas 7/21 R$ 121,42, 5/5 R$ 15,84 e 4/4 R$ 10,51. O centavo restante (1/N do Pluggy vs parcela da fatura, ~R$ 0,21) não tem outro lançamento para corrigir.
