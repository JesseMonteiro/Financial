...
- **`date` em PENDING parcelado ≠ data da compra.** Inter manda a data **prevista do lançamento da parcela** (pode ser futuro). Ex.: `99PAY` R$ 5,70 com `date: 2026-09-04`, `installmentNumber: 2`, `totalInstallments: 2`, `billId` da fatura de set/2026. Sem badge de parcela na UI parece compra à vista no futuro.
