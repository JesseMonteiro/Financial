...
- **Compras paralelas idênticas**: duas Óticas Rocha 70,00 10× compartilham a mesma series key. Projetar com `slots = count(N−1 no venc. anterior) − count(N no alvo)` — senão a segunda 7/10 some da fatura aberta (~R$ 70).
