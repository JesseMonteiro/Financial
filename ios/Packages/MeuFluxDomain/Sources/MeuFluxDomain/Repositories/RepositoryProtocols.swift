...
public protocol TransactionsRepository: Sendable {
    ...
    func fetchCategories(force: Bool) async throws -> [TransactionCategory]
    func updateCategory(id: String, categoryId: String) async throws
}
...
public extension TransactionsRepository {
    ...
    func fetchCategories(force: Bool = false) async throws -> [TransactionCategory] {
        _ = force
        return []
    }
...
public protocol PurchaseCategoriesRepository: Sendable {
    func fetchCategories(force: Bool) async throws -> [PurchaseCategory]
    func saveCategory(_ category: PurchaseCategory) async throws
    func deleteCategory(id: String) async throws
}

public extension PurchaseCategoriesRepository {
    func fetchCategories() async throws -> [PurchaseCategory] {
        try await fetchCategories(force: false)
    }
}
