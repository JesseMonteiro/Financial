    ...
    public var body: some View {
        Button(action: action) {
            Text(title)
                ...
                .foregroundStyle(isSelected ? FinancialColors.textInverse : FinancialColors.textPrimary)
                .padding(.horizontal, 14)
                .padding(.vertical, 8)
                .background {
                    Capsule()
                        .fill(isSelected ? FinancialColors.primary : Color.white.opacity(0.85))
                }
                .overlay {
                    Capsule().strokeBorder(isSelected ? Color.clear : FinancialColors.border, lineWidth: 1)
                }
        }
        .buttonStyle(.plain)
...
public struct MetricCard: View {
    ...
    public init(
        ...
        value: String,
        subtitle: String? = nil,
        tint: Color = FinancialColors.primary,
    ...
    public var body: some View {
        HStack(spacing: 12) {
            Image(systemName: isCredit ? "arrow.down.left" : "arrow.up.right")
                .font(.subheadline.weight(.semibold))
                .foregroundStyle(isCredit ? FinancialColors.success : FinancialColors.danger)
                .frame(width: 36, height: 36)
                .background(
                    (isCredit ? FinancialColors.success : FinancialColors.danger).opacity(0.12),
                    in: Circle()
                )
...
public struct MoneyText: View {
    ...
    public var body: some View {
        Text(formatted)
            ...
            .foregroundStyle(amount < 0 ? FinancialColors.danger : FinancialColors.textPrimary)
...
public struct StatusBadge: View {
    ...
    private var foreground: Color {
        switch style {
        case .success: return FinancialColors.success
        case .danger: return FinancialColors.danger
        case .warning: return FinancialColors.warning
        case .info: return FinancialColors.info
        case .neutral: return FinancialColors.textSecondary
        }
    }
...
public struct OfflineBanner: View {
    public var body: some View {
        ...
        .foregroundStyle(FinancialColors.textInverse)
        .padding(.horizontal, 16)
        .padding(.vertical, 10)
        .background(FinancialColors.warning)
...
public struct Badge: View {
    ...
    private var backgroundColor: Color {
        switch style {
        case .neutral: return FinancialColors.tertiaryBackground
        case .success: return FinancialColors.successBackground
        case .warning: return FinancialColors.warningBackground
        case .danger: return FinancialColors.dangerBackground
        case .info: return FinancialColors.infoBackground
        }
    }
    
    private var textColor: Color {
        switch style {
        case .neutral: return FinancialColors.textPrimary
        case .success: return FinancialColors.success
        case .warning: return FinancialColors.warning
        case .danger: return FinancialColors.danger
        case .info: return FinancialColors.info
            ...
            Text(text)
                ...
                .background(
                    RoundedRectangle(cornerRadius: 16)
                        .fill(isSelected ? FinancialColors.primary : Color.clear)
                        .overlay(
                            RoundedRectangle(cornerRadius: 16)
                                .stroke(FinancialColors.primary, lineWidth: 1)
                        )
                )
                .foregroundStyle(isSelected ? .white : FinancialColors.primary)
        }
        .buttonStyle(.plain)
    }
}
