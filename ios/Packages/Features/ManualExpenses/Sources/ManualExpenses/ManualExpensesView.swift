...
public struct ManualExpensesView: View {
    ...
    public var body: some View {
        ...
        .financialPageTitle("Despesas Manuais")
            ...
            HStack(alignment: .top, spacing: 10) {
                if group.isSeries {
                    ...
                    Image(systemName: "dollarsign.circle.fill")
                        ...
                        .background(FinancialColors.dangerBackground, in: Circle())
                }
    ...
    private func installmentRow(
        ...
        .padding(.vertical, 8)
        .background(
            installment.isPaid ? FinancialColors.successBackground : FinancialColors.bgTertiary,
            in: RoundedRectangle(cornerRadius: Radius().sm, style: .continuous)
        )
        .overlay {
            RoundedRectangle(cornerRadius: Radius().sm, style: .continuous)
                .strokeBorder(
                    installment.isPaid ? FinancialColors.success.opacity(0.35) : FinancialColors.border,
                    lineWidth: 1
                )
        }
    ...
    private func categoryBadge(_ category: String?) -> some View {
        let label = ManualExpenseCategory.label(for: category)
    ...
    private func color(for token: ColorToken) -> Color {
        ...
        case .green: return FinancialColors.success
        case .yellow: return Color(hex: 0xEAB308)
        case .slate: return FinancialColors.textSecondary
        case .primary: return FinancialColors.primary
        }
    }
            ...
            Form {
                ...
                Section {
                    Picker("Categoria", selection: $viewModel.draftCategory) {
                        ForEach(ManualExpenseCategory.allCases) { category in
